...
const allUpperCase = (arr) => {
  let newArr = [];
  arr.forEach(element => newArr.push(element.toUpperCase(element)))
  return newArr;
};
...
const greeting = (word) => {
  let newArr = [];
  word.forEach(element => newArr.push(element.toUpperCase(element + '!')))
};

const speaker = (words, callback) => {
  document.getElementById(word) => push
  return words
};
